...
$sql="UPDATE datos SET NombreServicio='$nom', Direccion='$dir', RFC='$rfc', Telefono='$tel', Latitud='$lat', Longitud='$longt', Foto='$foto', clasificacion_id='$clasif' WHERE IdServicios=$id";
